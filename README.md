...
3. На дашборде нажмите «Список пользователей».
4. В таблице нажмите «Редактировать» → откроется модальное окно.
5. Введите новый пароль и подтвердите → «Сохранить». При успехе появится сообщение.
